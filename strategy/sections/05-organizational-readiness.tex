...
%==============================================================================
\strategyPart{Section 04 \textbar\ Organizational Readiness}{Maturity Levels and Organizational ``Stocks''}
...
\begin{center}
  \begin{tabular}{@{}p{0.30\linewidth}@{\hspace{0.6cm}}p{0.30\linewidth}@{\hspace{0.6cm}}p{0.30\linewidth}@{}}
    \aiCard{%
      ...
      AI-literate leadership, data and ML talent, and a workforce trained to
    ...
    \aiCard{%
      ...
      Redesigned workflows, aligned incentives, decision rights and cross-
...
\begin{center}
  ...
  \begin{tabular}{>{\raggedright\arraybackslash}p{3.2cm}>{\raggedright\arraybackslash}p{3.2cm}>{\raggedright\arraybackslash}p{5.2cm}}
    \rowcolor{inNavy}
