...
%==============================================================================
\strategyPart{22 \textbar\ Executive Conclusion}{Executive Conclusion and Call to Action}
...
\begin{center}
  \stat{\$13T}{AI value by 2030\\(McKinsey 2018)}
  \qquad\qquad
  \stat{\$2.6--4.4T}{Annual gen-AI value\\(McKinsey 2023)}
  \qquad\qquad
  \stat{65\%}{Of orgs now use gen AI\\(McKinsey 2024)}
\end{center}

\begin{center}
  \stat{85\%}{Of AI projects errored\\(Gartner 2018)}
  \qquad\qquad
  \stat{30\%}{Abandoned after PoC\\(Gartner 2023)}
  \qquad\qquad
