...
%==============================================================================
\strategyPart{Section 02 \textbar\ Value Creation}{The AI Value Creation Ladder}
...
\begin{center}
  ...
  \begin{tabular}{>{\raggedright\arraybackslash}p{2.1cm}>{\raggedright\arraybackslash}p{3.2cm}>{\raggedright\arraybackslash}p{6.3cm}}
    \rowcolor{inNavy}
